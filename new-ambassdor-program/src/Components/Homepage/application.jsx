  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="text-center pt-6 pb-5">
        <h1 className="text-3xl font-bold text-[#26306D]">
          Application form
        </h1>
...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="order-1 md:order-none">
      ...
      <label className="text-sm mt-4 block">How familiar are you with RWAs?</label>
      <textarea
        className="w-full bg-transparent border-b border-white/40 focus:border-white outline-none py-1"
        rows={1}
      ></textarea>
      ...
      <label className="text-sm mt-4 block">
        How would you grow your local community and engage users around the BIGOD brand?
      </label>
      <textarea
    ...
    <div className="order-3 md:order-none">
      ...
      <label className="text-sm mt-4 block">Why join the BIGOD Ambassador Program?</label>
      <textarea
        className="w-full bg-transparent border-b border-white/40 focus:border-white outline-none py-1"
        rows={1}
      ></textarea>
